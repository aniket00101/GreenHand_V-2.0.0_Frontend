      ...
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6 lg:p-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm font-medium mt-1"> Fill in the details below to get started. </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <input type="text" placeholder="John Doe" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} required className="w-full border-2 border-green-500 bg-gray-50 p-3 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-200 focus:border-green-600 transition-all"/>
            ...
            <div className="mt-6 text-center space-y-3">
              ...
              <p className="text-sm text-gray-600"> Already have an account?{" "}
                ...
                <span onClick={() => navigate("/login")} className="text-green-700 font-bold cursor-pointer hover:underline"> Sign in </span>
        ...
        <div className="hidden md:block md:w-5/12 relative overflow-hidden group">
          ...
          <img src={feedbackImg} alt="Signup Visual" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
